    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                {props.aktuellerBenutzer !== null && (props.aktuellerBenutzer.rolle.kannKommentareLöschen || props.aktuellerBenutzer.id===props.kommentar.nutzer.id) &&  <KommentarBearbeitungsMenue aktuellerBenutzer={props.aktuellerBenutzer} kommentar={props.kommentar}/>}
            </div>
        </div>
    );
};
